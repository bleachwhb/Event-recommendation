...
public class Item {
	...
	public boolean equals(Object o1) {
		...
		if(o1 instanceof Item) {
			Item another = (Item)o1;
			if(this.getAddress() == null || this.getName() == null) {
				return false;
			} else {
				return this.getAddress().equals(another.getAddress()) && this.getName().equals(another.getName());
			}
		} else {
			return false;
		}
	...
	public int hashCode() {
		...
		if(this.getAddress() != null) {
			res += 31*this.getAddress().hashCode();
		}
		if(this.getName()!= null) {
			res += this.getName().hashCode();
		}
		return res;
	}
	...
	public static class ItemBuilder {
		...
		public ItemBuilder setTraffic_duration(String duration) {
			this.duration = duration;
			return this;		
		}
		public ItemBuilder setTraffic_distance(String distance) {
			this.distance = distance;
			return this;		
		}
		public ItemBuilder setMin(double min) {
			this.min = min;
			return this;
		}
		public ItemBuilder setMax(double max) {
			this.max = max;
			return this;
		}
		public Item build() {
